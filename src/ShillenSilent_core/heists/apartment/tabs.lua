...
do
	...
	apartmentSoloLaunchToggle = ui.toggle(
		gApartmentLaunch,
	...
	apartmentP1SliderRef = ui.slider(
		gApartmentCuts,
		"apartment_cut_p1",
		"Host Cut %",
		0,
	...
	apartmentP2SliderRef = ui.slider(
		gApartmentCuts,
		"apartment_cut_p2",
		"Player 2 Cut %",
		0,
	...
	apartmentP3SliderRef = ui.slider(
		gApartmentCuts,
		"apartment_cut_p3",
		"Player 3 Cut %",
		0,
	...
	apartmentP4SliderRef = ui.slider(
		gApartmentCuts,
		"apartment_cut_p4",
		"Player 4 Cut %",
		0,
	...
	apartmentMaxPayoutToggleRef = ui.toggle(
		gApartmentCuts,
		"apartment_max_payout",
		"3mil Payout",
		apartment_max_payout_enabled,
		function(val)
	...
	apartmentDoubleToggleRef = ui.toggle(
		gApartmentCuts,
		"apartment_double_rewards",
		"Double Rewards Week",
		apartment_double_rewards_week,
		function(val)
	...
	apartmentBonusToggleRef = ui.toggle(
		gApartmentBonuses,
		"apartment_12m_bonus",
		"Enable 12M Bonus",
		apartment_bonus_enabled,
		function(val)

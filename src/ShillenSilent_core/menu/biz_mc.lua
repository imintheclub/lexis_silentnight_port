...
function biz_mc.register(parent_menu)
	...
	common.add_toggle(biz_mc.ctx, global_sub, "Disable Raids", function()
		return mc_logic.get_raids_active()
	end, function(enabled)
		mc_logic.set_disable_raids(enabled)
	end)
	common.add_button(global_sub, "Kill MC Black Screen", function()

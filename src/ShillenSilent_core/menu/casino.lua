...
function casino_menu.register(parent_menu)
	...
	common.add_button(root, "Teleport to Arcade", function()
	...
	local tp_in_heist = root:submenu("Teleport (In Heist)")
	tp_in_heist:breaker("Inside Casino")
	common.add_button(tp_in_heist, "Staff Lobby (Inside)", function()
		run_coords_teleport("Casino Teleport", "Teleported to Staff Lobby", 2547.0, -270.0, -58.0)
	end)
	common.add_button(tp_in_heist, "Side Safe", function()
		run_coords_teleport("Casino Teleport", "Teleported to Side Safe", 2522.0, -287.0, -58.0)
	end)
	common.add_button(tp_in_heist, "Tunnel Door", function()
		run_coords_teleport("Casino Teleport", "Teleported to Tunnel Door", 2469.0, -279.0, -70.0)
	end)
	tp_in_heist:breaker("Outside Casino")
	common.add_button(tp_in_heist, "Tunnel", function()
		run_coords_teleport("Casino Teleport", "Teleported to Tunnel", 968.0, -73.0, 75.0)
	end)
	common.add_button(tp_in_heist, "Staff Lobby (Outside)", function()

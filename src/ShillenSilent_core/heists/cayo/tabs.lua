...
cayoUnlockOnApplyToggle = ui.toggle(
	gCayoPreps,
...
cayoRemoveCrewCutsToggle = ui.toggle(
	gCayoCuts,
	"cayo_remove_crew_cuts",
	"Remove Crew Cuts",
	cayo_remove_crew_cuts_enabled,
	function(val)

...
function controller.register(parent_menu)
	...
	local tools = root:submenu(t("nightclub.group.tools"))
	common.add_button(tools, t("nightclub.action.open_computer"), actions.open_computer)
	common.add_button(tools, t("nightclub.action.skip_setup"), actions.skip_setup)

	local danger = root:submenu(t("nightclub.group.danger"))
	controls.cooldowns_toggle = common.add_toggle(ctx, danger, t("nightclub.action.kill_cooldowns"), function()

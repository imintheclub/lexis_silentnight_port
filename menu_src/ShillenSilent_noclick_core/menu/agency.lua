local agency_logic = require("ShillenSilent_noclick_core.heists.agency.logic")
local heist_state = require("ShillenSilent_noclick_core.shared.heist_state")
local common = require("ShillenSilent_noclick_core.menu.common")
...
function agency_menu.refresh_controls()
	...
	common.set_control_value(ctx, controls.payout_number, common.clamp_int(AgencyConfig.payout, 0, 2500000))
	return true
end
...
function agency_menu.register(parent_menu)
	...
	controls.payout_number = common.add_number_int(ctx, payout, "Payout", 0, 2500000, 50000, function()

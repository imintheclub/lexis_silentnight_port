...
function salvageyard_menu.register(parent_menu)
	...
	common.add_button(root, "Teleport to Entrance", function()
	...
	common.add_button(tools, "Teleport to Screen & Board", function()
	...
	common.add_button(tools, "Instant Sell", function()
		salvageyard_logic.salvage_instant_sell()
	end)
	common.add_button(tools, "Tow Truck Instant Finish", function()
		salvageyard_logic.salvage_tow_truck_instant_finish()
	end)
	common.add_button(tools, "Force Through Error", function()
		salvageyard_logic.salvage_force_through_error()
	end)
	common.add_button(tools, "Collect Safe", function()
	...
	local popularity = root:submenu("Popularity")
	common.add_number_int(ctx, popularity, "Popularity", 0, 100, 5, function()
		return salvageyard_logic.salvage_get_popularity_editor_value()
	end, function(value)
		salvageyard_logic.salvage_set_popularity_editor_value(value)
	end)
	common.add_button(popularity, "Apply Popularity", function()
		salvageyard_logic.salvage_apply_popularity_editor_value()
	end)
	common.add_toggle(ctx, popularity, "Lock Popularity", function()
		return salvageyard_logic.salvage_get_popularity_lock_active()
	end, function(enabled)
		salvageyard_logic.salvage_set_popularity_lock_active(enabled)
	end)

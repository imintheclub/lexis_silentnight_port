...
function apartment_menu.register(parent_menu)
	...
	controls.bonus_toggle = common.add_toggle(ctx, cuts, "Enable 12M Bonus", function()
	...
	common.add_button(tools, "Instant Finish (Pacific Standard)", function()
		apartment_instant_finish_pacific()
	end)
	common.add_button(tools, "Instant Finish (Other)", function()
		apartment_instant_finish_other()
	end)

	local tp_in_heist = root:submenu("Teleport (In Heist)")
	common.add_button(tp_in_heist, "Teleport to Heist Board", function()

...
casinoAutograbberToggle = ui.toggle(
	gTools,
	"casino_autograbber",
	"Autograbber",
	casino_autograbber_enabled,
	function(val)
...
manualUnlockPoiToggle = ui.toggle(
	gManualPreps,
	"manual_unlock_poi",
...
casinoRemoveCrewCutsToggle = ui.toggle(
	gCuts,
	"casino_remove_crew_cuts",
	"Remove Crew Cuts",
	casino_remove_crew_cuts_enabled,
	function(val)
